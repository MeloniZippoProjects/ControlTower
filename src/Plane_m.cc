...
Plane::Plane(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->ID = 0;
...
::omnetpp::simtime_t Plane::getEnqueueTimestamp() const
{
    return this->enqueueTimestamp;
}

void Plane::setEnqueueTimestamp(::omnetpp::simtime_t enqueueTimestamp)
{
...
PlaneDescriptor::PlaneDescriptor() : omnetpp::cClassDescriptor("Plane", "omnetpp::cPacket")
{
...
int PlaneDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='e' && strcmp(fieldName, "enqueueTimestamp")==0) return base+1;
...
std::string PlaneDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return simtime2string(pp->getEnqueueTimestamp());
        default: return "";
    }
}
...
bool PlaneDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setEnqueueTimestamp(string2simtime(value)); return true;
